...
const STEPS = [
  {
    ...
    body: "Deterministic code — not AI — queries the parcel against seven public GIS layers. Same input, same output, every time. This is what makes offering Lot Check for free, unlimited, no account required, possible at all.",
  },
  {
    n: "02",
